...
public class EditMoodActivity extends AppCompatActivity {
    ...
    /**
     * First set the original mood
     * Then get the update of the mood
    ...
    /**
     * First check if the device is online or not
     * if the device is online, delete the old mood
     * upload the new updated mood to the server
     * if the device is not online, we store the change
     * wait for the device to come online and upload to server
     * @param view
     */
    ...
    public void findlocation(View view){ //find location
    ...
    /**
     * set the photo and location to the new mood
     * @param requestCode
     * @param resultCode
     * @param data
     */
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case 98:
                ...
                break;
            case 1: // when user pick a location
                if (resultCode == RESULT_OK) {
