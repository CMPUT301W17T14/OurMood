...
public class FriendRequestActivity extends AppCompatActivity {
    ...
    /**
     * This is an activity to allow user to accpte or decline a follow request
     * it can get a request from elasticsearch
     ...
     * shows a user name, accept button, decline button and a text view
     * which is "want to follow you"
     */
