...
/**
 * this java file set the adapter of every mood events in the moodeventlist
 * and every items in the moodeventlist has it's own interface
 */
public class MoodeventAdapter extends ArrayAdapter<Mood> {
    ...
    /**
     * get the mood details and show some details in the mood event list
     * @param position
     * @param convertView
     * @param parent
     * @return
    ...
    /**
     * set the background color of every list items according to its mood state
     * @param example
     * @param row
     */
    ...
    /**
     * set the mood state to integer and it will be easiler to set the emoji
     * and show some specific detail of the mood item
     * @param example
     */
    ...
    /**
     * set the emoji according to the mood emotion
     * @param emoji
     * @param emotion
     */
