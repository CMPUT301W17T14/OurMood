...
/**
 * This is a activity to allow user to send a follow request to
 * other users, when other users accept, this user can see their
 * mood event
 */
public class AddFollowActivity extends AppCompatActivity {
    ...
    /**
     * send the follow request to other user through elasticsearch
     * @param followname
     */
